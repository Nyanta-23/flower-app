<section id="navbar" class="container z-1 d-flex justify-content-center">
    ...
    <div class="row border-top mt-5 py-2 rounded-5 bg-light mt-lg bottom-nav mb-3 mx-sm-2">

        <div class="col-sm-12 d-flex justify-content-center">

            <ul class="z-10 d-flex justify-content-between align-items-center px-0 py-3 gap-1 border-top rounded-top-5 shadow-navigation bg-light bottom-nav w-100 mb-0 pb-3">
                <li class="list-group-item mx-auto pb-3 pb-md-3 pb-lg-0">
                    <a href="/"
